...
from store import redis_client, find_game_by_active_player, save_game_to_redis
...
async def inline_query_handler(update, context):
    ...
    # Find the game where this user is the active player
...
async def chosen_inline_result_handler(update, context):
    ...
    # Find the game where this user is playing
    chat_id, game = find_game_by_active_player(redis_client, user_id)
